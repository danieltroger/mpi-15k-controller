 ...
 *
 * To convert rawdata to mV, see this code snippet:
 * ```
 *    // no scale for raw data
 *     if (rawdata)
 *         return true;
 *
 *     // scale raw value to milli-volt
 *     switch(gain)
 *     {
 *         case GAIN_6144: value /= 6.0; break;
 *         case GAIN_4096: value /= 8.0; break;
 *         case GAIN_2048: value /= 16.0; break;
 *         case GAIN_1024: value /= 32.0; break;
 *         case GAIN_512:  value /= 64.0; break;
 *         case GAIN_256:  value /= 128.0; break;
 *     }
 *
 *     value = round(value);
 * ```
