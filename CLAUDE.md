...
- **Descriptive variable names** — it should say on the lid what's in the box. No `Sdd`/`k`/`e` single-letter soup outside a 3-line lambda; bundle size is irrelevant, maintainability isn't.
